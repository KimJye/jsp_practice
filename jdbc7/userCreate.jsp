<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="jdbc6.*, java.net.*, java.util.*, lecture1.*"%>
<%
		...
		if (able == null) able = "";
     	...
     	if(request.getMethod().equals("GET")){
     		...
     		String s2 = request.getParameter("departmentId");
       		user.setDepartmentId(ParseUtils.parseInt(s2,0));
       		...
       		if(user.getUserid()==null || user.getUserid().length()==0)
				...
				UserDAO.insert(user);
				response.sendRedirect("Example.jsp?pg=99999");
				return;
			}
...
<form method="post">
	...
	<a href="userListPage.jsp?pg=<%=pg %>&st=<%=srchTextEncoded %>&de<%=de %>&od=<%=od %>"
